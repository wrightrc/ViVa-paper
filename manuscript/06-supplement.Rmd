...
ggsave("full-IAA-alignment.tiff", dpi = 800)
```
...
ggsave("IAA6-div-plot.tiff", dpi = 800)
```
...
ggsave("full-AFBs-alignment.tiff", dpi = 800)
```
...
ggsave("full-TPLs-alignment.tiff", dpi = 800)
```
...
ggsave("full-ARFs-alignment.tiff", dpi = 800)
