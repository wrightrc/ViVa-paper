...
For simplicity we have included only the alignment of the class A Aux/IAAs in the main manuscript. For completion we include here the complete alignment of the family (Figure \@ref(fig:full-IAA-alignment)). 
