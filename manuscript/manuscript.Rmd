...
write.nexus.data(AAAlign_no_gaps, file = "~/Desktop/natural-variation-webtool/manuscript/IAAs.nex", format = "protein")
```
```{bash eval=FALSE}
mb

execute /Volumes/SSD/Users/clayw/Desktop/natural-variation-webtool/manuscript/IAAs.nex
...
```{r}
tree <- treeio::read.beast(file = "~/Desktop/natural-variation-webtool/manuscript/IAAs.nex.con.tre")

IAA_data <- read.csv("~/Dropbox/natural-variation-webtool/manuscript_IAA_A/Alex_Tree_work/IAAs_table.csv")
