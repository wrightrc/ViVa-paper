...
Although most known functional regions are highly conserved in *AFB1*, there is a nonsynonymous polymorphism  in the oligomerization domain, only found in the Can-0 accession. Mutations in this domain of *TIR1* frequently have a semidominant effect on root phenotypes [@dezfulian_oligomerization_2016; @wright_insights_2017a]. Characterization of this accession may identify potential *AFB1* phenotypes and may also test the hypothesis that AFB1 functions through oligomerization with other TIR1/AFBs.
...
ARF_data <- read.csv(system.file("shiny-app", "gene_family_data",
                      "ARF_gene_ids.csv", package = "r1001genomes"))
ARF_data %<>% left_join(y = div_stats$x$data, by = c("name" = "tair_symbol"))
#tip_labels need to be in the first column
...
*ARF23*, which has a truncated DNA-binding domain, has a high ${\pi_N/\pi_S}$ value of 4.1, and has many high-diversity nonsense variants, as may be expected of a gene that is pseudogenizing. 
