...
Now when you click on the "kitematic" folder you will see the contents of this folder. Any files you save in this folder will be saved to the folder you mapped on your computer. You can also open files from this folder in RStudio. In the RStudio "Files" pane, navigate to the "manuscript" folder and set it as your working directory (using the "More" button). Click on "manuscript.Rmd" to open the manuscript markdown file. 
